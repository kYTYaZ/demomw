                                                    ...
                                                    <table>
                                                        <tr>
                                                            <th>
                                                                ...
                                                                Has generado una reserva en este establecimiento, estamos verificando la disponibilidad de un espacio de trabajo, en pocos minutos te confirmaremos.
                                                                </p>
                                                        ...
                                                        <tr>
                                                          <th class="button-container">
                                                            <a style="margin-top: 10px" href="{{url("/reservations/".$data["reservation_id"])}}">IR A MIS RESERVAS</a>
                                                          </th>
                                                        </tr>
                                                    </table>
                                                </th>
