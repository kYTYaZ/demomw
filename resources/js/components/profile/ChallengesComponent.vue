...
<div class="container">
	<div class="row">
		<div class="col col-xl-6 col-lg-12 col-md-12 col-sm-12 col-12" v-for="item in challenges">
			<div class="ui-block">
				...
				<article class="hentry post has-post-thumbnail thumb-full-width">
					...
					<a href="#" data-toggle="modal" data-target="#blog-post-popup" class="h2 post-title">Convocatoria tal y pascual</a>
